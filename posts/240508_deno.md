...
![making a new repo called 'deno_server' on github](/240508/deno_new_repo.png)
...
![empty VSCode window, open at 'deno_server'](/240508/deno_vs_code_empty.png)
...
![terminal in VSCode displaying "hello from Deno!"](/240508/deno_hello.png)
...
![deno_server folder with server.js file and public folder, with index.html, script.js, and favicon.ico inside public](/240508/deno_file_structure.png)
...
![Deno asking for net access permission in the VSCode terminal](/240508/deno_allow-net.png)
...
![a blank webpage that says "Hello, from the Deno server!!"](/240508/deno_first_serve.png)
...
![browser window displaying the text: "Not Found"](/240508/deno_not_found.png)
...
![a website with a turquoise background and a pink square](/240508/deno_explicit_index.png)
...
![the same website (turquoise with a pink square), but from localhost instead of localhost/index.html](/240508/deno_default_to_index.png)

Git add / commit / push like this:

![git add / commit / push in the VSCode terminal](/240508/deno_add_commit_push.png)
...
![the Deno Deploy dashboard, with a "View" button](/240508/deno_deploy_dash.png)

Clicking on **View** will take you to where your server has been deployed:

![the turquoise website with a pink square, but hosted from a deno.dev URL](/240508/deno_deployed.png)
