...
<img src="/240405/pfp_glasses.jpg" id="glitch_self_portrait"/>

<script>
   const img = document.getElementById (`glitch_self_portrait`)
   console.dir (img.src)
   ...
   //    console.dir (d)
   //    og_img = await d.target.result
   //    // draw_frame ()
   // }

   reader.readAsDataURL (og_img) 

   // draw_frame () {
   //    console.log (`drawing`)
   //    img.src = glitchify (og_img)
